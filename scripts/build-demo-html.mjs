...
const sections = [
  ...
  },
  {
    ...
    steps: [
      ...
      '演示账号：16688096890 / Mentor@2026（张忠程老师）。',
  ...
  },
  {
    ...
    steps: [
      '提交后自动进入方案详情页：归因结论、行动项列表、7 天复盘节点。',
      '方案详情页展示来源评估与归因摘要，行动项带截止时间。',
    ...
    shots: [
      { file: '06-plan-created.png', caption: '方案详情：归因结论 + 行动项 + 7 天复盘节点' },
  ...
  },
  {
    ...
    title: '安全基线、试点节奏与边界',
    steps: [
      '安全基线一句话：字段级加密、Argon2id 密码、敏感接口 no-store、水印、无批量导出、权限矩阵。',
...
<div class="container">
  ...
  <div class="closing">
    <h2>演示前检查清单</h2>
    <p>① 服务就绪：访问 http://localhost:3300 健康检查通过，数据库已 seed（六力学校与四个演示账号）。</p>
    <p>② 演示账号：16688096890（教师）/ 13800000002（心理专员）/ 13800000001（学校管理员）/ 13800000000（平台管理员），密码统一 Mentor@2026。</p>
