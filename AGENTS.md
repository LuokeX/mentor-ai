...
- SSE 事件当前为：`ack`（额外带会话绑定对象、本轮对象/候选、切换提示等字段，事件名不变）、`answer_start`、`thinking`、`tool_call`、`tool_result`、`sources`、`action_card`、`answer_delta`、`module_proportions`、`answer`、`fuse`、`error`、`done`。改动事件名必须同时更新前端消费方。
