...
export default defineEventHandler(() => ({
  ...
  paths: {
    ...
    '/api/v1/chat/messages': { post: { summary: '安全检查、受控上下文和 AI 助手回答（SSE）', responses: { 200: { description: 'SSE events: ack(dataGovernance), answer_start, thinking, tool_call, tool_result, sources, action_card, answer_delta, module_proportions, answer, fuse, error, done' }, 409: { description: 'Session context cannot be switched silently' } } } },
