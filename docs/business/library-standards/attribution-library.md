...
统一模板见 `docs/business/library-standards/三库整理总模板.xlsx`。如果需要按模块拆分导入，可把归因相关 Sheet 拆到 `business-libraries/[module]/attribution.xlsx`，运行时发布到 `module_resource_libraries.library_type = attribution`。
