...
const { rows, total, page, pageSize, sort, order, loading, error, onSortChange, onPageChange, onPageSizeChange, refresh } = useManagedList<{ id: string; action: string; targetType: string; actorId: string; result: string; createdAt: string }>('/api/v1/platform-admin/audit-logs')
