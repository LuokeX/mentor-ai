...
const nav = [
  ...
  { id: 'assignment', label: '负责教师分配', icon: 'i-lucide-git-branch' }, { id: 'crises', label: '危机转介', icon: 'i-lucide-siren' }, { id: 'approvals', label: '访问审批', icon: 'i-lucide-shield-check' }, { id: 'audit', label: '访问审计', icon: 'i-lucide-scroll-text' }, { id: 'settings', label: '学校配置', icon: 'i-lucide-settings' }
]
